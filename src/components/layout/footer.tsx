          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-zinc-100 text-zinc-600 transition-all hover:bg-zinc-900 hover:text-white dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-white dark:hover:text-zinc-900"
                aria-label="GitHub"
              >
